<template>
  <div class="page-container" style="width:99%;margin-top:80px;margin-left: 10px;">
    <el-carousel :interval="3000" type="card" height="450px" class="carousel">
      <el-carousel-item class="carousel-item-intro">
        <h2>项目介绍</h2>
        <ul>
          <li>基于 Spring Boot、Vue、Element 的 Java EE 传感器信息平台</li>
        </ul>
      </el-carousel-item>
      ...
      <el-carousel-item class="carousel-item-env">
        ...
        <ul>
          ...
          <li>IDE : webStorm。    Webpack：webpack 4.41.x。</li>
          <li>NODE: Node 12.14.x。      YARN : YARN 1.2.x。</li>
        </ul>
        <h2>技术选型</h2>
        <ul>
